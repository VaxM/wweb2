    ...
    return (
        ...
        >
            <div className="w-full max-w-sm bg-white dark:bg-slate-800 rounded border-primary shadow-md border dark:border-0 dark:shadow-xl p-6">
                <div className = "flex flex-col space-y-4">
                    ...
                    <button
                        onClick={() => {}}
                        disabled={false}
                        className="bg-blue-600 text-white text-sm font-semibold px-6 py-3 rounded hover:bg-blue-500 flex justify-center items-center space-x-1 active:ring-1"
                        >
            ...
            <div className = "flex justify-center space-x-4 text-sm p-4">
                <button className="hover:underline text-blue-500 font-semibold">Terms</button>
                <button className="hover:underline text-blue-500 font-semibold">Privacy Policy</button>
            </div>
        </div>
    );
};
