...
const TextField = ({
    ...
    return (
        <div className="w-full text-sm relative space-y-1">
            ...
            <div className={`${errors.length ? 'ring-1 ring-red-500' : isFocused ? 'ring-1 ring-blue-600' : ''} ${TEXT_FIELD_CLASSES[color]} w-full border shadow-sm rounded flex justify-center items-center border-primary`}>
